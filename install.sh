...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/nextcloud"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="nextcloud"
INSTDIR="$HOME/.local/share/dockermgr/nextcloud"
APPDIR="$HOME/.local/share/srv/docker/nextcloud"
DATADIR="$HOME/.local/share/srv/docker/nextcloud/files"
